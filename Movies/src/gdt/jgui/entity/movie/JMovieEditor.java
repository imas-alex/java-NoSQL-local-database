...
public class JMovieEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	public static final String ACTION_CREATE_MOVIE="action create movie";
	...
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JMovieEditor.class.getName());
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
			// System.out.println("JBankEditor:reindex:0:entity="+entity.getProperty("label"));
		    	String fhandler$=MovieHandler.class.getName();
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "Movie"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"Movie entity");
	    JMovieEditor fe=new JMovieEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JMovieEditor.class.getName());
		...
		responseLocator.setProperty(Locator.LOCATOR_TITLE,"Movie");
...
//		System.out.println("JBankEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				Sack newEntity=entigrator.ent_new("movie", text$);
				newEntity.createElement("field");
				newEntity.putElementItem("field", new Core(null,"Title",null));
				
				newEntity.createElement("fhandler");
				newEntity.putElementItem("fhandler", new Core(null,MovieHandler.class.getName(),JMovieFacetAddItem.EXTENSION_KEY));
				...
				Support.addHandlerIcon(JMovieEditor.class, "movie.png", icons$);
