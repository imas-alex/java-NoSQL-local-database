...
public class JRoleEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	public static final String ACTION_CREATE_ROLE="action create role";
	...
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JRoleEditor.class.getName());
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
			// System.out.println("JBankEditor:reindex:0:entity="+entity.getProperty("label"));
		    	String fhandler$=RoleHandler.class.getName();
	...
	public String newEntity(JMainConsole console, String locator$) {
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JRoleEditor.class.getName());
		...
		responseLocator.setProperty(Locator.LOCATOR_TITLE,"Role");
...
//		System.out.println("JBankEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				Sack newEntity=entigrator.ent_new("role", text$);
				newEntity.createElement("field");
				newEntity.putElementItem("field", new Core(null,"Role",null));
				newEntity.createElement("fhandler");
				newEntity.putElementItem("fhandler", new Core(null,RoleHandler.class.getName(),RoleHandler.EXTENSION_KEY));
				...
				Support.addHandlerIcon(JRoleEditor.class, "role.png", icons$);
...
//				System.out.println("JBankEditor:response:name="+core.name+" value="+core.value);
	...
	public JFacetRenderer instantiate(JMainConsole console, String locator$) {
		try{
			System.out.println("JRoleEditor.instantiate:begin");
