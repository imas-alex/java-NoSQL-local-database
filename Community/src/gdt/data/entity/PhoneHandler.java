...
public class PhoneHandler extends FacetHandler{
...
public final static String PHONE="phone";
	...
	public String instantiate( String locator$) {
        ...
        locator$=Locator.append(locator$,BaseHandler.HANDLER_CLASS,PhoneHandler.class.getName());
...
//			System.out.println("PhoneHandler:isApplied:entity="+entity.getProperty("label"));
			...
			if(phone$!=null&&!Locator.LOCATOR_FALSE.equals(phone$)){
