...
public String getWebView(Entigrator entigrator, String locator$) {
	try{
	    ...
	    Properties idLocator=new Properties(); 
	    idLocator.setProperty(BaseHandler.HANDLER_CLASS,JEntityFacetPanel.class.getName());
    	idLocator.setProperty(Entigrator.ENTIHOME,entigrator.getEntihome());
    	idLocator.setProperty(WContext.WEB_HOME, webHome$);
    	idLocator.setProperty(WContext.WEB_REQUESTER, this.getClass().getName());
     	sb.append(" var locator=\""+Locator.toString(idLocator)+"\";");
    	...
    	headerLocator.setProperty(WContext.WEB_REQUESTER, webRequester$);
     	sb.append(" var locator=\""+Locator.toString(headerLocator)+"\";");
     	sb.append(" locator=appendProperty(locator,\""+EntityHandler.ENTITY_LABEL+"\",\""+entityLabel$+"\");");
     	sb.append(" locator=appendProperty(locator,\""+JViewPanel.SORT_COLUMN_NAME+"\",header);");
     	sb.append("console.log(locator);");
    	sb.append(" var href=\""+webHome$+"?"+WContext.WEB_LOCATOR+"=\"+window.btoa(locator);");
    	sb.append("console.log(href);");
    	sb.append("window.localStorage.setItem(\"back."+JEntityFacetPanel.class.getName()+"\",\""+this.getClass().getName()+"\");");
