...
/**
* Contains methods to process a procedure entity.
...
public class ProcedureHandler extends FacetHandler {
	...
	/**
	 * Check if the procedure handler is applied to the entity  
	...
	public boolean isApplied(Entigrator entigrator, String locator$) {
		try{
	    	...
	    	String procedure$=entity.getProperty("procedure");
	 ...
	 /**
     * Get title of the procedure handler.  
	...
	public String getTitle() {
	 ...
	 /**
     * Get type of the procedure handler.  
	...
	public String getType() {
	 ...
	 /**
     * Get class name of the procedure handler.  
	...
	private void adaptLabel(Entigrator entigrator){
		 try{
				Sack entity=entigrator.getEntityAtKey(entityKey$);
				entigrator.ent_assignProperty(entity, "procedure", entityLabel$);
		    }catch(Exception e){
	...
	*/
	...
	public void adaptClone(Entigrator entigrator) {
	   ...
	   Sack entity=entigrator.getEntityAtKey(entityKey$);
	   String templateKey$=entity.getAttributeAt("template");
	   File source=new File(entigrator.getEntihome()+"/"+entityKey$+"/"+templateKey$+".java");
	   if(source.exists()){
		   File dest=new File(entigrator.getEntihome()+"/"+entityKey$+"/"+entityKey$+".java");
		   source.renameTo(dest);
	   }
	   File classFile=new File(entigrator.getEntihome()+"/"+entityKey$+"/"+templateKey$+".class");
	   if(classFile.exists()){
		   File dest=new File(entigrator.getEntihome()+"/"+entityKey$+"/"+entityKey$+".class");
