...
public class JNwCustomerFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwCustomerFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw customer");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwCustomerFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw customer facet");
	locator.setProperty(FACET_HANDLER_CLASS,NwCustomerHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwCustomerHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public String getFacetIcon(Entigrator entigrator) {
	if(entihome$!=null)
		...
		return ExtensionHandler.loadIcon(entigrator,NwCategoryHandler.EXTENSION_KEY, "nwCustomer.png");
}
@Override
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwCustomerEditor customerEditor=new JNwCustomerEditor();
		String aeLocator$=customerEditor.getLocator();
...
public String getFacetRenderer() {
	return JNwCustomerEditor.class.getName();
}
@Override
