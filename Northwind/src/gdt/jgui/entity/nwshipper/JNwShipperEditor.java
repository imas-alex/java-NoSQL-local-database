...
public class JNwShipperEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	
	boolean debug=false;
	public JNwShipperEditor() {
		super();
	}
	@Override
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JNwShipperEditor.class.getName());
	...
	public String getCategoryIcon(Entigrator entigrator) {
		return ExtensionHandler.loadIcon(entigrator, NwShipperHandler.EXTENSION_KEY, "nwShipper.png");
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
		    	...
		    	String fhandler$=NwShipperHandler.class.getName();
		    	if(entity.getElementItem("fhandler", fhandler$)!=null){
		    		entity.putElementItem("jfacet", new Core(JNwShipperFacetAddItem.class.getName(),fhandler$,JNwShipperFacetOpenItem.class.getName()));
					entity.putElementItem("fhandler", new Core(null,fhandler$,NwShipperHandler.EXTENSION_KEY));
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "nwShipper"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"nwShipper entity");
	    JNwShipperEditor fe=new JNwShipperEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JNwShipperEditor.class.getName());
		...
		responseLocator.setProperty(Locator.LOCATOR_TITLE,"nwShipper");
	...
	//	System.out.println("JAddressEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				...
				newEntity.putElementItem("fhandler", new Core(null,NwShipperHandler.class.getName(),NwShipperHandler.EXTENSION_KEY));
				...
				newEntity.putAttribute(new Core (null,"icon","nwShipper.png"));
				entigrator.replace(newEntity);
				entigrator.ent_assignProperty(newEntity, "fields", text$);
				entigrator.ent_assignProperty(newEntity, "nwShipper", text$);
				String icons$=entihome$+"/"+Entigrator.ICONS;
				Support.addHandlerIcon(JNwShipperEditor.class, "nwShipper.png", icons$);
