...
public class JNwShipperFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwShipperFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw shipper");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwShipperFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw shipper facet");
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw shipper");
	locator.setProperty(FACET_HANDLER_CLASS,NwShipperHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwShipperHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwShipperEditor addressEditor=new JNwShipperEditor();
...
public String getFacetRenderer() {
	return JNwShipperEditor.class.getName();
}
@Override
