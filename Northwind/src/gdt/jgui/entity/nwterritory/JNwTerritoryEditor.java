...
public class JNwTerritoryEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	
	boolean debug=false;
	public JNwTerritoryEditor() {
		super();
	}
	@Override
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JNwTerritoryEditor.class.getName());
	...
	public String getCategoryIcon(Entigrator entigrator) {
		return ExtensionHandler.loadIcon(entigrator, NwTerritoryHandler.EXTENSION_KEY, "nwTerritory.png");
			
	}

	@Override
	public String getCategoryTitle() {
		return "nwTerritories";
	}
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
			// System.out.println("JPhoneEditor:reindex:0:entity="+entity.getProperty("label"));
		    	String fhandler$=NwTerritoryHandler.class.getName();
		    	if(entity.getElementItem("fhandler", fhandler$)!=null){
		    		entity.putElementItem("jfacet", new Core(JNwTerritoryFacetAddItem.class.getName(),fhandler$,JNwTerritoryFacetOpenItem.class.getName()));
					entity.putElementItem("fhandler", new Core(null,fhandler$,NwTerritoryHandler.EXTENSION_KEY));
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "nwTerritory"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"nwTerritory entity");
	    JNwTerritoryEditor fe=new JNwTerritoryEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JNwTerritoryEditor.class.getName());
	...
	//	System.out.println("JAddressEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				...
				newEntity.putElementItem("fhandler", new Core(null,NwTerritoryHandler.class.getName(),NwTerritoryHandler.EXTENSION_KEY));
				...
				newEntity.putAttribute(new Core (null,"icon","nwTerritory.png"));
				entigrator.ent_alter(newEntity);
				entigrator.ent_assignProperty(newEntity, "fields", text$);
				entigrator.ent_assignProperty(newEntity, "nwTerritory", text$);
				String icons$=entihome$+"/"+Entigrator.ICONS;
				Support.addHandlerIcon(JNwTerritoryEditor.class, "nwTerritory.png", icons$);
