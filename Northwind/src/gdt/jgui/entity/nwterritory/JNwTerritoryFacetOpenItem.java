...
public class JNwTerritoryFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwTerritoryFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw territory");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwTerritoryFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw territory facet");
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw territory");
	locator.setProperty(FACET_HANDLER_CLASS,NwTerritoryHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwTerritoryHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwTerritoryEditor addressEditor=new JNwTerritoryEditor();
...
public String getFacetRenderer() {
	return JNwTerritoryEditor.class.getName();
}
@Override
