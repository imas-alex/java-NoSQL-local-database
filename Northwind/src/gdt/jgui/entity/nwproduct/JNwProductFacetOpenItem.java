...
public class JNwProductFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwProductFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw product");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwProductFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw product facet");
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw product");
	locator.setProperty(FACET_HANDLER_CLASS,NwProductHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwProductHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwProductEditor addressEditor=new JNwProductEditor();
...
public String getFacetRenderer() {
	return JNwProductEditor.class.getName();
}
@Override
