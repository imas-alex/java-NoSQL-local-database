...
public class JNwCategoryFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwCategoryFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw category");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwCategoryFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw category facet");
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw category");
	locator.setProperty(FACET_HANDLER_CLASS,NwCategoryHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwCategoryHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwCategoryEditor addressEditor=new JNwCategoryEditor();
...
public String getFacetRenderer() {
	return JNwCategoryEditor.class.getName();
}
@Override
