...
public class JNwOrderDetailFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwOrderDetailFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwOrderDetailFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw order detail facet");
	locator.setProperty(FACET_HANDLER_CLASS,NwOrderDetailHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwOrderDetailHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public String getFacetIcon(Entigrator entigrator) {
	if(entihome$!=null)
		...
		return ExtensionHandler.loadIcon(entigrator,NwOrderDetailHandler.EXTENSION_KEY, "nwOrder.Detailpng");
}
@Override
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwOrderDetailEditor orderEditor=new JNwOrderDetailEditor();
...
public String getFacetRenderer() {
	return JNwOrderDetailEditor.class.getName();
}
@Override
