...
public class JNwOrderDetailEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	boolean debug=false;
	public JNwOrderDetailEditor() {
		super();
	}
	@Override
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JNwOrderDetailEditor.class.getName());
	...
	public String getCategoryIcon(Entigrator entigrator) {
		return ExtensionHandler.loadIcon(entigrator, NwOrderDetailHandler.EXTENSION_KEY, "nwOrder.png");
	}

	@Override
	public String getCategoryTitle() {
		return "nwOrdersDetails";
	}
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
			// System.out.println("JPhoneEditor:reindex:0:entity="+entity.getProperty("label"));
		    	String fhandler$=NwOrderDetailHandler.class.getName();
		    	if(entity.getElementItem("fhandler", fhandler$)!=null){
		    		entity.putElementItem("jfacet", new Core(JNwOrderDetailFacetAddItem.class.getName(),fhandler$,JNwOrderDetailFacetOpenItem.class.getName()));
					entity.putElementItem("fhandler", new Core(null,fhandler$,NwOrderDetailHandler.EXTENSION_KEY));
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "nwOrderDetail"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"nwOrderDetail entity");
	    JNwOrderDetailEditor fe=new JNwOrderDetailEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JNwOrderDetailEditor.class.getName());
		...
		responseLocator.setProperty(Locator.LOCATOR_TITLE,"nwOrderDetail");
	...
	//	System.out.println("JAddressEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				...
				newEntity.putElementItem("fhandler", new Core(null,NwOrderDetailHandler.class.getName(),NwOrderDetailHandler.EXTENSION_KEY));
				newEntity.putElementItem("fhandler", new Core(null,FieldsHandler.class.getName(),null));
				newEntity.createElement("jfacet");
				newEntity.putElementItem("jfacet", new Core("gdt.jgui.entity.nworderdetail.JNwOrderDetailFacetAddItem",NwOrderDetailHandler.class.getName(),"gdt.jgui.entity.nworderdetail.JNwOrderDetailFacetOpenItem"));
				...
				entigrator.ent_assignProperty(newEntity, "nwOrderDetail", text$);
				String icons$=entihome$+"/"+Entigrator.ICONS;
				Support.addHandlerIcon(JNwOrderDetailEditor.class, "nwOrderDetail.png", icons$);
