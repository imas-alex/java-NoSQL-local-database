...
public class JNwSupplierEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	
	boolean debug=false;
	public JNwSupplierEditor() {
		super();
	}
	@Override
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JNwSupplierEditor.class.getName());
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
		    	...
		    	String fhandler$=NwSupplierHandler.class.getName();
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "nwSupplier"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"nwSupplier entity");
	    JNwSupplierEditor fe=new JNwSupplierEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JNwSupplierEditor.class.getName());
		...
		responseLocator.setProperty(Locator.LOCATOR_TITLE,"nwSupplier");
	...
	//	System.out.println("JAddressEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				...
				newEntity.putElementItem("fhandler", new Core(null,NwSupplierHandler.class.getName(),NwSupplierHandler.EXTENSION_KEY));
				...
				Support.addHandlerIcon(JNwSupplierEditor.class, "nwSupplier.png", icons$);
