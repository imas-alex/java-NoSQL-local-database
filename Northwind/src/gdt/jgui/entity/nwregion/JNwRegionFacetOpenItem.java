...
public class JNwRegionFacetOpenItem extends JFieldsFacetOpenItem  {
	private static final long serialVersionUID = 1L;
	public JNwRegionFacetOpenItem(){
		super();
	}
...
public String getLocator(){
	...
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw region");
	locator.setProperty(BaseHandler.HANDLER_CLASS,JNwRegionFacetOpenItem.class.getName());
	...
	locator.setProperty( JContext.CONTEXT_TYPE,"Nw region facet");
	locator.setProperty(Locator.LOCATOR_TITLE,"Nw region");
	locator.setProperty(FACET_HANDLER_CLASS,NwRegionHandler.class.getName());
	if(entityKey$!=null)
	...
	locator.setProperty(Locator.LOCATOR_ICON_LOCATION,NwRegionHandler.EXTENSION_KEY);
    if(entihome$!=null){   
...
public void openFacet(JMainConsole console,String locator$) {
	...
	//	System.out.println("JAddressFacetOpenItem:openFacet:locator="+locator$);
		...
		JNwRegionEditor addressEditor=new JNwRegionEditor();
...
public String getFacetRenderer() {
	return JNwRegionEditor.class.getName();
}
@Override
