...
public class JNwRegionEditor extends JFieldsEditor {

	private static final long serialVersionUID = 1L;
	
	boolean debug=false;
	public JNwRegionEditor() {
		super();
	}
	@Override
	public String getLocator() {
		try{
			...
			locator.setProperty(BaseHandler.HANDLER_CLASS,JNwRegionEditor.class.getName());
	...
	public String getCategoryIcon(Entigrator entigrator) {
		return ExtensionHandler.loadIcon(entigrator, NwRegionHandler.EXTENSION_KEY, "nwProduct.png");
	...
	public void reindex(JMainConsole console, Entigrator entigrator, Sack entity) {
		 try{
		    	...
		    	String fhandler$=NwRegionHandler.class.getName();
		    	if(entity.getElementItem("fhandler", fhandler$)!=null){
		    		entity.putElementItem("jfacet", new Core(JNwRegionFacetAddItem.class.getName(),fhandler$,JNwRegionFacetOpenItem.class.getName()));
					entity.putElementItem("fhandler", new Core(null,fhandler$,NwRegionHandler.EXTENSION_KEY));
	...
	public String newEntity(JMainConsole console, String locator$) {
	    ...
	    editorLocator$=Locator.append(editorLocator$, JTextEditor.TEXT, "nwRegion"+Identity.key().substring(0,4));
	    editorLocator$=Locator.append(editorLocator$,Locator.LOCATOR_TITLE,"nwRegion entity");
	    JNwRegionEditor fe=new JNwRegionEditor();
	   ...
	   responseLocator.setProperty(BaseHandler.HANDLER_CLASS,JNwRegionEditor.class.getName());
	...
	//	System.out.println("JAddressEditor:response:"+Locator.remove(locator$,Locator.LOCATOR_ICON ));
		try{
			...
			if(ACTION_NEW_ENTITY.equals(action$)){
				...
				newEntity.putElementItem("fhandler", new Core(null,NwRegionHandler.class.getName(),NwRegionHandler.EXTENSION_KEY));
				...
				newEntity.putAttribute(new Core (null,"icon","nwRegion.png"));
				entigrator.replace(newEntity);
				entigrator.ent_assignProperty(newEntity, "fields", text$);
				entigrator.ent_assignProperty(newEntity, "nwRegion", text$);
				String icons$=entihome$+"/"+Entigrator.ICONS;
				Support.addHandlerIcon(JNwRegionEditor.class, "nwRegion.png", icons$);
